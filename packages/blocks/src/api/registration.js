...
export function registerBlockType( name, settings ) {
	...
	if ( ! isValidIcon( settings.icon.src ) ) {
		console.error(
			...
			'The icon should be a string, an element, a function, or an object following the specifications documented in https://wordpress.org/gutenberg/handbook/block-api/block-registration/#icon-optional'
		);
		return;
	}
